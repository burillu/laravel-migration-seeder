...
1.  Creiamo un database da phpmyadmin (es. train_db);
2. Creiamo una tabella trains e relativa Migration
...
- Create  relativo Controller per mostrare nella home page tutti i treni che sono in partenza dalla data odierna.
